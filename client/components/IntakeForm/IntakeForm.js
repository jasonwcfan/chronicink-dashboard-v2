                    ...
                    <div>
                        ...
                        <Stepper activeStep={this.state.stepIndex}>
                            <Step>
                                ...
                                <div style={style.stepLabelContent}>Personal Info
                                </div>
                                </StepLabel>
                            </Step>
                            <Step>
                                <StepLabel style={style.stepLabel}>
                                <div style={style.stepLabelContent}>Disclaimer
                                </div>
                                </StepLabel>
                            </Step>
                            <Step>
                                <StepLabel style={style.stepLabel}>
                                <div style={style.stepLabelContent}>My Availability
                                </div>
                                </StepLabel>
                            </Step>
                            <Step>
                                <StepLabel style={style.stepLabel}>
                                <div style={style.stepLabelContent}>Call Us
                                </div>
                                </StepLabel>
                            </Step>
                        </Stepper>
